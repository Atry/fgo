...
# tf.app.flags.DEFINE_string('outname', 'predictions.txt',
...
def get_classifier(model_dir):
  ...
  # print("getting softmax_tensor")
  softmax_tensor = sess.graph.get_tensor_by_name('softmax:0')
  pprint([op.name for op in sess.graph.get_operations()])
